...
public class RegistrationUpdate {
    ...
    public Registration update(Registration registration) {
        ...
        Map<String, String> additionalAttributes = this.additionalAttributes != null
    ...
    Map<String, String> updateAdditionalAttributes(Map<String, String> oldAdditionalAttributes) {

        // putAll method updates already present key values or add them if not present.
        oldAdditionalAttributes.putAll(this.additionalAttributes);
